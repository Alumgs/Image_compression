...
class KJPEG:
    ...
    def Decompress(self, filename):
        ...
        image.save("images/result.png", "png")
        image.show()
...
if __name__ == '__main__':
    kjpeg = KJPEG()
    kjpeg.Compress(r"E:\pythonProjects\GraDesign\MY_Design\images\1.png")
    kjpeg.Decompress(r"E:\pythonProjects\GraDesign\MY_Design\images\1.gpj")
