...
# 读取图像数据
img1 = tf.gfile.FastGFile(r'E:\pythonProjects\CNN_img_compression\data\images\0.png', 'rb').read()
img2 = tf.gfile.FastGFile(r'E:\pythonProjects\CNN_img_compression\output\_compressed_image.png_.png', 'rb').read()
