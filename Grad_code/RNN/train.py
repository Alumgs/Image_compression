...
flags.DEFINE_integer('batch_size', 1, 'batch size of training dataset')
...
with tf.Session() as sess:
    ...
    for epoch in range(opts.epochs):
        ...
        print("Epoch number: {} ms-ssim {} loss{}".format(epoch + 1, ms_ssim, cur_train_loss))
        ...
        imageio.imsave('eval/epoch_{}.jpg'.format(epoch + 1), output_img)
